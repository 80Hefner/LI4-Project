...
namespace FireSafe.DatabaseAccess
{
    public class IncendioDAO
    {
        ...
        public Incendio FindIncendioById(int id)
        {
            ...
            using (SqlCommand command = con.Fetch().CreateCommand())
            {
                ...
                command.CommandText = "SELECT * FROM [Incendio] WHERE Id=@Id";
        ...
        public Incendio FindIncendioByCoordenadas(float latitude, float longitude)
        {
            ...
            {
                command.CommandType = CommandType.Text;
                command.CommandText = "SELECT * FROM [Incendio] WHERE Latitude=@Latitude AND Longitude=@Longitude";
