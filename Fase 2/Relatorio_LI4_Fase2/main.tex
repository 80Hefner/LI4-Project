...
\begin{figure}[hbt!]
    \centering
    \frame{\includegraphics[width=1\textwidth]{images/Fase2/7.DiagramasDeSequenciaDeSubsistemas/1.consultaIncendio.png}}
...
\begin{figure}[hbt!]
    \centering
    \frame{\includegraphics[width=1\textwidth]{images/Fase2/7.DiagramasDeSequenciaDeSubsistemas/2.registarUtilizador.png}}
...
\begin{figure}[hbt!]
    \centering
    \frame{\includegraphics[width=1\textwidth]{images/Fase2/7.DiagramasDeSequenciaDeSubsistemas/3.loginUtilizador.png}}
...
\begin{figure}[hbt!]
    \centering
    \frame{\includegraphics[width=1\textwidth]{images/Fase2/7.DiagramasDeSequenciaDeSubsistemas/4.terminarSessao.png}}
...
\begin{figure}[hbt!]
    \centering
    \frame{\includegraphics[width=1\textwidth]{images/Fase2/7.DiagramasDeSequenciaDeSubsistemas/5.editarPerfil.png}}
...
\begin{figure}[hbt!]
    \centering
    \frame{\includegraphics[width=1\textwidth]{images/Fase2/7.DiagramasDeSequenciaDeSubsistemas/6.editarLocalizacoes.png}}
...
\begin{figure}[hbt!]
    \centering
    \frame{\includegraphics[width=1\textwidth]{images/Fase2/7.DiagramasDeSequenciaDeSubsistemas/7.editarNotificacoes.png}}
...
\begin{figure}[hbt!]
    \centering
    \frame{\includegraphics[width=1\textwidth]{images/Fase2/7.DiagramasDeSequenciaDeSubsistemas/8.consultaLocalizacoes.png}}
...
\begin{figure}[hbt!]
    \centering
    \frame{\includegraphics[width=1\textwidth]{images/Fase2/7.DiagramasDeSequenciaDeSubsistemas/9.consultaHistorico.png}}
